<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="burger.aspx.cs" Inherits="foodCourt.pages.burger" %>

<!DOCTYPE html>
<html id="head7" runat="server">
<head>
...
<div class="container">
  ...
  <asp:PlaceHolder ID="PlaceHolder_burger" runat="server"></asp:PlaceHolder>
