...
{
    public partial class sandwitch : System.Web.UI.Page
    {
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            if (!this.IsPostBack)
            {
                ...
                PlaceHolder_sandwitch.Controls.Add(new Literal { Text = html.ToString() });
            }
        }
        ...
        private DataTable GetData_sandwitch()
        {
            ...
            {
                using (SqlCommand cmd = new SqlCommand("SELECT name_of_dish, price,picture FROM tbl_sandwitch"))
                {
