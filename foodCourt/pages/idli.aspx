<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="idli.aspx.cs" Inherits="foodCourt.pages.idli" %>
...
<div class="container">
  ...
  <asp:PlaceHolder ID="PlaceHolder_idli" runat="server"></asp:PlaceHolder>
</div>
<footer id="footer">
