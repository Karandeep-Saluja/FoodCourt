<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="vegpizza.aspx.cs" Inherits="foodCourt.pages.vegpizza" %>
...
<div class="container">
  ...
  <div>
    ...
    <asp:PlaceHolder ID="PlaceHolder_vegpizza" runat="server"></asp:PlaceHolder>
